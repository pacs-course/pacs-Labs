...
extern template std::vector<double> operator*(SparseMatrix<double> &M, const std::vector<double> &x);
extern template std::ostream &operator<<(std::ostream &stream, SparseMatrix<double> &M);
