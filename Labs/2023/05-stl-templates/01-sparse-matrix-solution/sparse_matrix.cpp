...
// if you implement templates in the .cpp file you need explicit instantiation
// if you implement templates in the .hpp file you do NOT need the following lines since
