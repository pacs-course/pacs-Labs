...
\begin{document}
    ...
    \author
      {
      Paolo Joseph Baioni\\
      {\footnotesize Webex Room: \color{blue}\href{https://politecnicomilano.webex.com/meet/paolojoseph.baioni}{https://politecnicomilano.webex.com/meet/paolojoseph.baioni}}
      }
    \date{\today}
